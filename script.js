...
class PortfolioApp {
    ...
    handleCTAClick() {
        ...
        // Simulate CTA action (you can replace this with actual functionality)
        this.showNotification('Free trial started! Check your email for details.', 'success');
    ...
    startHeroAnimations() {
        ...
        const elements = [heroName, heroSubtitle, aboutText, ctaButton];
    ...
    addHoverEffects() {
        ...
        const interactiveElements = document.querySelectorAll('.nav-link, .cta-button, .contact-item');
    ...
    addLoadingAnimations() {
        ...
        const animatedElements = document.querySelectorAll('.hero-name, .hero-subtitle, .about-text, .cta-button');
